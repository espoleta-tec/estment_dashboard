...
Vue.component(QAvatar.name, QAvatar);
Vue.component(QBadge.name, QBadge);
Vue.component(QBanner.name, QBanner);
Vue.component(QBar.name, QBar);
...
Vue.component(QCardSection.name, QCardSection);
...
Vue.component(QIntersection.name, QIntersection);
...
Vue.component(QLinearProgress.name, QLinearProgress);
Vue.component(QList.name, QList);
Vue.component(QMarkupTable.name, QMarkupTable);
Vue.component(QMenu.name, QMenu);
...
Vue.component(QPageScroller.name, QPageScroller);
...
Vue.component(QPopupProxy.name, QPopupProxy);
...
Vue.component(QResizeObserver.name, QResizeObserver);
Vue.component(QResponsive.name, QResponsive);
Vue.component(QRouteTab.name, QRouteTab);
Vue.component(QScrollArea.name, QScrollArea);
Vue.component(QScrollObserver.name, QScrollObserver);
Vue.component(QSelect.name, QSelect);
Vue.component(QSeparator.name, QSeparator);
Vue.component(QSkeleton.name, QSkeleton);
Vue.component(QSlideItem.name, QSlideItem);
Vue.component(QSlideTransition.name, QSlideTransition);
Vue.component(QSlider.name, QSlider);
Vue.component(QSpace.name, QSpace);
...
Vue.component(QSpinnerBox.name, QSpinnerBox);
Vue.component(QSpinnerClock.name, QSpinnerClock);
...
Vue.component(QSpinnerOrbit.name, QSpinnerOrbit);
...
Vue.component(QSplitter.name, QSplitter);
...
Vue.component(QUploaderAddTrigger.name, QUploaderAddTrigger);
Vue.component(QUploaderBase.name, QUploaderBase);
Vue.component(QVideo.name, QVideo);
Vue.component(QVirtualScroll.name, QVirtualScroll);
